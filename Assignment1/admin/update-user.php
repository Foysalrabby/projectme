...
if(isset($_POST['submit'])){
    include 'config.php';
    $us_id = $_POST['user_id'];
    $us_fname = $_POST['f_name'];
    $us_lname = $_POST['l_name'];
    $usname = $_POST['username'];
    $us_role = $_POST['role'];
    $sql1="UPDATE`user`SET first_name='{$us_fname }',last_name='{$us_lname}',username='{$usname}',role='{$us_role}' WHERE user_id='{$us_id}'";
